...
CREATE TABLE IF NOT EXISTS Client (
  ...
  WID INT NULL,
  PRIMARY KEY (CID),
  FOREIGN KEY (WID) REFERENCES Worker (WID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS WorkerCreates (
  ...
  WID INT NOT NULL,
  PRIMARY KEY (FID, WID),
  FOREIGN KEY (FID) REFERENCES Favor (FID) ON DELETE CASCADE,
  FOREIGN KEY (WID) REFERENCES Worker (WID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS EventContractors (
  ...
  FOREIGN KEY (EID) REFERENCES Event (EID) ON DELETE CASCADE,
  FOREIGN KEY (ContID) REFERENCES Contractor(ContID) ON DELETE CASCADE
);
